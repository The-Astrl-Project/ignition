...
#
# This file is part of Ignition. It is subject to the license terms in
# the LICENSE file found in the top-level directory of this project and at
# https://github.com/The-Astrl-Project/ignition/blob/HEAD/LICENSE.
#
...
function blurb()
{
    ...
    echo
    echo "This program is part of Ignition. It is subject to the license terms in"
    echo "the LICENSE file found in the top-level directory of this project and at"
    echo "https://github.com/The-Astrl-Project/ignition/blob/HEAD/LICENSE."
    echo
...
function help()
{
    echo "Astrl: Ignition Build Script - Provide utility functions for building Ignition"
    echo
